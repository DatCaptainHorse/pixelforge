...
impl Av1 {
    ...
    pub fn create(context: VideoContext, config: EncodeConfig) -> Result<CodecEncoder<Self>> {
        ...
        let mut qp_map_codec_caps = vk::VideoEncodeAV1QuantizationMapCapabilitiesKHR::default();
        ...
        let qp_map_plan = crate::encoder::codec::QpMapCaps {
            min_delta: qp_map_codec_caps.min_q_index_delta,
            max_delta: qp_map_codec_caps.max_q_index_delta,
