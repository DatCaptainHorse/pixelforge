...
# The examples carry a shader of their own.
EXAMPLE_SRC="$PROJECT_ROOT/examples/shader/sample_frame.comp"
EXAMPLE_SPV="$PROJECT_ROOT/examples/shader/sample_frame.spv"
echo "Compiling sample_frame.comp → sample_frame.spv"
